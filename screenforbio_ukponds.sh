...
bash ~/src/screenforbio-mbc-uk_ponds-cw/get_taxonomy.sh Tetrapoda superclass ~/src/screenforbio-mbc-uk_ponds-cw/
# Success.
...
# output is Tetrapoda_ITIS_taxonomy.txt, a copy of which is in screenforbio-mbc-uk_ponds-cw/archived_files/
...
cd ~/src/screenforbio-mbc-uk_ponds-cw/
. ~/.linuxify; which sed # should show /usr/local/opt/gnu-sed/libexec/gnubin/sed
# copy MIDORI files that i want to process to the working directory: screenforbio-mbc-uk_ponds-cw/
...
cd ~/src/screenforbio-mbc-uk_ponds-cw/
. ~/.linuxify; which sed # should show /usr/local/opt/gnu-sed/libexec/gnubin/sed
bash ~/src/screenforbio-mbc-uk_ponds-cw/get_sequences.sh yes no two Tetrapoda ~/src/screenforbio-mbc-uk_ponds-cw/
...
cd ~/src/screenforbio-mbc-uk_ponds-cw/
. ~/.linuxify; which sed # should show /usr/local/opt/gnu-sed/libexec/gnubin/sed
bash ~/src/screenforbio-mbc-uk_ponds-cw/get_sequences.sh yes no four Tetrapoda ~/src/screenforbio-mbc-uk_ponds-cw/
...
cd ~/src/screenforbio-mbc-uk_ponds-cw/
. ~/.linuxify; which sed # should show /usr/local/opt/gnu-sed/libexec/gnubin/sed
bash ~/src/screenforbio-mbc-uk_ponds-cw/train_protax.sh Tetrapoda.final_protax_taxonomy.txt ~/src/screenforbio-mbc-uk_ponds-cw
...
# unweighted
bash check_protax_training.sh model_12S Tetrapoda 12S ~/src/screenforbio-mbc-uk_ponds-cw/
bash check_protax_training.sh model_16S Tetrapoda 16S ~/src/screenforbio-mbc-uk_ponds-cw/

# weighted
bash check_protax_training.sh w_model_12S Tetrapoda 12S ~/src/screenforbio-mbc-uk_ponds-cw/
bash check_protax_training.sh w_model_16S Tetrapoda 16S ~/src/screenforbio-mbc-uk_ponds-cw/
...
bash protax_classify_otus.sh ${OTUS12S_SWARM} 12S protaxmodels ~/src/screenforbio-mbc-uk_ponds-cw protaxout_swarm
bash protax_classify_otus.sh ${OTUS16S_SWARM} 16S protaxmodels ~/src/screenforbio-mbc-uk_ponds-cw protaxout_swarm
# bash protax_classify_otus.sh ${OTUS12S_USEARCH} 12S protaxmodels ~/src/screenforbio-mbc-uk_ponds-cw protaxout_usearch
...
bash weighted_protax_classify_otus.sh ${OTUS12S_SWARM} 12S w_protaxmodels_uk_ponds ~/src/screenforbio-mbc-uk_ponds-cw w_protaxout_swarm
bash weighted_protax_classify_otus.sh ${OTUS16S_SWARM} 16S w_protaxmodels_uk_ponds ~/src/screenforbio-mbc-uk_ponds-cw w_protaxout_swarm
# bash weighted_protax_classify_otus.sh ${OTUS12S_USEARCH} 12S w_protaxmodels_uk_ponds ~/src/screenforbio-mbc-uk_ponds-cw w_protaxout_usearch
...
bash protax_classify_otus.sh ${OTUS12S_SWARM} 12S protaxmodels ~/src/screenforbio-mbc-uk_ponds-cw w_protaxout_swarm_20190704
...
# bash weighted_protax_classify_otus.sh ${OTUS16S_SWARM} 16S w_protaxmodels_ailaoshan ~/src/screenforbio-mbc-uk_ponds-cw w_protaxout_swarm_20190624
# bash protax_classify_otus.sh ${OTUS16S_SWARM} 16S protaxmodels ~/src/screenforbio-mbc-uk_ponds-cw protaxout_swarm_20190624
     # usage: bash weighted_protax_classify_otus.sh otus locus protaxdir screenforbio outdir
     # where:
     # otus is the (path to) the OTU fasta to be processed (suffix should be ".fa")
     # locus is the target locus, must be one of: 12S, 16S, CYTB, COI. if you have more than one locus to analyse, run script once for each.
